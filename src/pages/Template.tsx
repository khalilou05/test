        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
          {templates.map((template, idx) => (
            <button
              key={idx}
              type="button"
              className={`relative flex flex-col items-center justify-end transition-all duration-150 ease-in-out focus:outline-none select-none shadow-xl group overflow-hidden border-0 mx-auto mt-0 mb-6 sm:mb-0 ${
                 idx === 0
